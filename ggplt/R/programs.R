...
program_code <- list(
  ...
  # Part B: Time Series Analysis of Multiple Datasets
  partb = paste0(
    "#DATASET1\n",
    ...
    "plot(AirPassengers, main = \"AirPassengers Time Series\", ylab = \"Passengers (in thousands)\", xlab = \"Year\")\n\n",
    "# 2. Preprocessing\n",
    "# Check for missing values\n",
    "cat(\"Missing values:\", sum(is.na(AirPassengers)), \"\\n\")\n\n",
    "# Convert to time series object (already a time series object)\n",
    "cat(\"Time series start:\", start(AirPassengers), \"\\n\")\n",
    "cat(\"Time series end:\", end(AirPassengers), \"\\n\")\n",
    ...
    "if (adf_test$p.value < 0.05) {\n",
    "  cat(\"Result: Reject the null hypothesis. The series is stationary.\\n\")\n",
    "} else {\n",
    "  cat(\"Result: Fail to reject the null hypothesis. The series is non-stationary.\\n\")\n",
    "}\n\n",
    "# KPSS Test\n",
    "kpss_test <- kpss.test(AirPassengers, null = \"Level\")\n",
    "cat(\"KPSS Test:\\n\")\n",
    "cat(\"Null Hypothesis: The series is stationary around a level.\\n\")\n",
    "cat(\"p-value:\", kpss_test$p.value, \"\\n\")\n",
    "if (kpss_test$p.value < 0.05) {\n",
    "  cat(\"Result: Reject the null hypothesis. The series is non-stationary.\\n\")\n",
    "} else {\n",
    "  cat(\"Result: Fail to reject the null hypothesis. The series is stationary.\\n\")\n",
    "}\n\n",
    "# 4. Differencing and Transformations\n",
    "# Apply log transformation to stabilize variance\n",
    "log_airpassengers <- log(AirPassengers)\n",
    "plot(log_airpassengers, main = \"Log Transformed AirPassengers\", ylab = \"Log(Passengers)\", xlab = \"Year\")\n\n",
    "# Apply differencing to make the series stationary\n",
    "diff_log_airpassengers <- diff(log_airpassengers)\n",
    "plot(diff_log_airpassengers, main = \"Differenced Log AirPassengers\", ylab = \"Differenced Log(Passengers)\", xlab = \"Year\")\n\n",
    "# Test stationarity again\n",
    "adf_test_diff <- adf.test(diff_log_airpassengers, alternative = \"stationary\")\n",
    "cat(\"ADF Test after differencing:\\n\")\n",
    "cat(\"p-value:\", adf_test_diff$p.value, \"\\n\")\n\n",
    "# 5. Model Selection\n",
    "# Fit ARIMA model\n",
    "fit <- auto.arima(log_airpassengers)\n",
    ...
    "plot(forecast_values, main = \"Forecast of AirPassengers\", ylab = \"Log(Passengers)\", xlab = \"Year\")\n\n",
    "# Convert forecast back to original scale\n",
    "forecast_original <- exp(forecast_values$mean)\n",
    "plot(forecast_original, main = \"Forecast of AirPassengers (Original Scale)\", ylab = \"Passengers (in thousands)\", xlab = \"Year\")\n\n",
    "# 8. Conclusions\n",
    "cat(\"Summary of Findings:\\n\")\n",
    "cat(\"- The original AirPassengers dataset was non-stationary, as indicated by stationarity tests.\\n\")\n",
    "cat(\"- Log transformation and differencing were applied to make the series stationary.\\n\")\n",
    "cat(\"- An ARIMA model was selected and fitted to the transformed series.\\n\")\n",
    "cat(\"- The residuals of the model resemble white noise, indicating a good fit.\\n\")\n",
    "cat(\"- Forecasts were made for the next 24 months and plotted in both log and original scales.\\n\")\n\n",
    "#DATASET2\n",
    "# Load necessary libraries\n",
    "library(forecast)\n",
    "library(tseries)\n",
    ...
    "data(\"nottem\")\n",
    "summary(nottem)\n",
    "plot(nottem, main = \"Monthly Temperatures in Nottingham\", ylab = \"Temperature (F)\", xlab = \"Year\")\n\n",
    "# Description of the dataset\n",
    "cat(\"Dataset Summary:\\n\")\n",
    "cat(\"- Monthly average temperatures from 1920 to 1939.\\n\")\n",
    "cat(\"- Measures temperature in degrees Fahrenheit.\\n\")\n\n",
    "# 2. Preprocessing\n",
    "# Check for missing values\n",
    "cat(\"Missing values:\", sum(is.na(nottem)), \"\\n\")\n\n",
    "# Convert to time series object (already a time series object)\n",
    "cat(\"Time series start:\", start(nottem), \"\\n\")\n",
    "cat(\"Time series end:\", end(nottem), \"\\n\")\n",
    "cat(\"Frequency:\", frequency(nottem), \"\\n\")\n\n",
    "# 3. Stationarity Testing\n",
    "# Augmented Dickey-Fuller Test\n",
    "adf_test <- adf.test(nottem, alternative = \"stationary\")\n",
    "cat(\"ADF Test:\\n\")\n",
    "cat(\"Null Hypothesis: The series has a unit root (non-stationary).\\n\")\n",
    "cat(\"p-value:\", adf_test$p.value, \"\\n\")\n",
    "if (adf_test$p.value < 0.05) {\n",
    ...
    "}\n\n",
    "# KPSS Test\n",
    "kpss_test <- kpss.test(nottem, null = \"Level\")\n",
    "cat(\"KPSS Test:\\n\")\n",
    "cat(\"Null Hypothesis: The series is stationary around a level.\\n\")\n",
    "cat(\"p-value:\", kpss_test$p.value, \"\\n\")\n",
    "if (kpss_test$p.value < 0.05) {\n",
    ...
    "plot(diff_nottem, main = \"Differenced Monthly Temperatures\", ylab = \"Differenced Temperature (F)\", xlab = \"Year\")\n\n",
    "# Check stationarity after differencing\n",
    "adf_test_diff <- adf.test(diff_nottem, alternative = \"stationary\")\n",
    "cat(\"ADF Test after differencing:\\n\")\n",
    "cat(\"p-value:\", adf_test_diff$p.value, \"\\n\")\n\n",
    "# 5. Model Selection\n",
    "# Fit ARIMA model\n",
    "fit <- auto.arima(nottem)\n",
    "cat(\"Selected ARIMA Model:\\n\")\n",
    "print(fit)\n\n",
    "# 6. Model Diagnostics\n",
    "checkresiduals(fit)\n\n",
    ...
    "# Forecast next 24 months\n",
    "forecast_values <- forecast(fit, h = 24)\n",
    "plot(forecast_values, main = \"Forecast of Monthly Temperatures\", ylab = \"Temperature (F)\", xlab = \"Year\")\n\n",
    "# 8. Conclusions\n",
    "cat(\"Summary of Findings:\\n\")\n",
    "cat(\"- The original nottem dataset was analyzed for trends and seasonality.\\n\")\n",
    "cat(\"- Stationarity tests (ADF and KPSS) indicated the series was non-stationary.\\n\")\n",
    "cat(\"- Differencing was applied to achieve stationarity.\\n\")\n",
    "cat(\"- An ARIMA model was selected and fitted to the data.\\n\")\n",
    "cat(\"- Model diagnostics confirmed the residuals behaved like white noise.\\n\")\n",
    "cat(\"- Forecasts were made for the next 24 months and plotted.\\n\")\n\n",
    "#DATASET3\n",
    "# Load necessary libraries\n",
    "library(forecast)\n",
    "library(tseries)\n",
    ...
    "data(\"lynx\")\n",
    "summary(lynx)\n",
    "plot(lynx, main = \"Lynx Trapping Data\", ylab = \"Number of Lynx\", xlab = \"Year\")\n\n",
    "# Description of the dataset\n",
    "cat(\"Dataset Summary:\\n\")\n",
    "cat(\"- Annual numbers of lynx trapped in Canada from 1821 to 1934.\\n\")\n",
    "cat(\"- Useful for studying population dynamics and ecological modeling.\\n\")\n\n",
    "# 2. Preprocessing\n",
    "# Check for missing values\n",
    "cat(\"Missing values:\", sum(is.na(lynx)), \"\\n\")\n\n",
    "# Convert to time series object (already a time series object)\n",
    "cat(\"Time series start:\", start(lynx), \"\\n\")\n",
    "cat(\"Time series end:\", end(lynx), \"\\n\")\n",
    "cat(\"Frequency:\", frequency(lynx), \"\\n\")\n\n",
    "# 3. Stationarity Testing\n",
    "# Augmented Dickey-Fuller Test\n",
    "adf_test <- adf.test(lynx, alternative = \"stationary\")\n",
    "cat(\"ADF Test:\\n\")\n",
    "cat(\"Null Hypothesis: The series has a unit root (non-stationary).\\n\")\n",
    "cat(\"p-value:\", adf_test$p.value, \"\\n\")\n",
    "if (adf_test$p.value < 0.05) {\n",
    ...
    "}\n\n",
    "# KPSS Test\n",
    "kpss_test <- kpss.test(lynx, null = \"Level\")\n",
    "cat(\"KPSS Test:\\n\")\n",
    "cat(\"Null Hypothesis: The series is stationary around a level.\\n\")\n",
    "cat(\"p-value:\", kpss_test$p.value, \"\\n\")\n",
    "if (kpss_test$p.value < 0.05) {\n",
    ...
    "# Apply log transformation to stabilize variance\n",
    "log_lynx <- log(lynx)\n",
    "plot(log_lynx, main = \"Log Transformed Lynx Data\", ylab = \"Log(Number of Lynx)\", xlab = \"Year\")\n\n",
    "# Apply differencing to make the series stationary\n",
    "diff_log_lynx <- diff(log_lynx)\n",
    "plot(diff_log_lynx, main = \"Differenced Log Transformed Lynx Data\", ylab = \"Differenced Log(Lynx)\", xlab = \"Year\")\n\n",
    "# Check stationarity after differencing\n",
    "adf_test_diff <- adf.test(diff_log_lynx, alternative = \"stationary\")\n",
    "cat(\"ADF Test after differencing:\\n\")\n",
    "cat(\"p-value:\", adf_test_diff$p.value, \"\\n\")\n\n",
    "# 5. Model Selection\n",
    "# Fit ARIMA model\n",
    "fit <- auto.arima(log_lynx)\n",
    "cat(\"Selected ARIMA Model:\\n\")\n",
    "print(fit)\n\n",
    "# 6. Model Diagnostics\n",
    "checkresiduals(fit)\n\n",
    ...
    "plot(forecast_values, main = \"Forecast of Lynx Population\", ylab = \"Log(Number of Lynx)\", xlab = \"Year\")\n\n",
    "# Convert forecast back to original scale\n",
    "forecast_original <- exp(forecast_values$mean)\n",
    "plot(forecast_original, main = \"Forecast of Lynx Population (Original Scale)\", ylab = \"Number of Lynx\", xlab = \"Year\")\n\n",
    "# 8. Conclusions\n",
    "cat(\"Summary of Findings:\\n\")\n",
    "cat(\"- The original lynx dataset was analyzed for trends and seasonality.\\n\")\n",
    "cat(\"- Stationarity tests (ADF and KPSS) indicated the series was non-stationary.\\n\")\n",
    "cat(\"- Log transformation and differencing were applied to make the series stationary.\\n\")\n",
    "cat(\"- An ARIMA model was selected and fitted to the data.\\n\")\n",
    "cat(\"- Model diagnostics confirmed the residuals behaved like white noise.\\n\")\n",
    "cat(\"- Forecasts were made for the next 10 years and plotted in both log and original scales.\\n\")\n\n",
    "#DATASET4\n",
    ...
    "summary(sunspots)\n",
    "plot(sunspots, main = \"Monthly Sunspots\", ylab = \"Sunspots Count\", xlab = \"Time\")\n",
    "cat(\"Dataset Description: Monthly counts of sunspots from 1749 to 1983. Used for solar activity analysis and forecasting cycles.\\n\")\n\n",
    "# Step 2: Preprocessing\n",
    "# Checking for missing values\n",
    "cat(\"Number of missing values:\", sum(is.na(sunspots)), \"\\n\")\n\n",
    "# Checking for outliers using boxplot\n",
    "boxplot(sunspots, main = \"Boxplot for Sunspots\", ylab = \"Sunspots Count\")\n\n",
    "# Converting to a time series object\n",
    "sunspots_ts <- ts(sunspots, start = c(1749, 1), frequency = 12)\n",
    "plot(sunspots_ts, main = \"Monthly Sunspots (Time Series)\", ylab = \"Sunspots Count\", xlab = \"Time\")\n\n",
    "# Step 3: Stationarity Testing\n",
    "# Augmented Dickey-Fuller (ADF) Test\n",
    "adf_test <- adf.test(sunspots_ts, alternative = \"stationary\")\n",
    "cat(\"ADF Test Results:\\n\")\n",
    "cat(\"P-value:\", adf_test$p.value, \"\\n\")\n",
    "cat(\"Null Hypothesis (H0): The time series is non-stationary.\\n\")\n",
    "cat(\"Alternative Hypothesis (H1): The time series is stationary.\\n\")\n",
    "if (adf_test$p.value < 0.05) {\n",
    ...
    "}\n\n",
    "# KPSS Test\n",
    "kpss_test <- kpss.test(sunspots_ts)\n",
    "cat(\"KPSS Test Results:\\n\")\n",
    "cat(\"P-value:\", kpss_test$p.value, \"\\n\")\n",
    "cat(\"Null Hypothesis (H0): The time series is stationary.\\n\")\n",
    "cat(\"Alternative Hypothesis (H1): The time series is non-stationary.\\n\")\n",
    "if (kpss_test$p.value < 0.05) {\n",
    "  cat(\"Conclusion: Reject H0. The series is non-stationary.\\n\")\n",
    "} else {\n",
    "  cat(\"Conclusion: Fail to reject H0. The series is stationary.\\n\")\n",
    "}\n\n",
    "# Step 4: Differencing and Transformations\n",
    "diff_sunspots <- diff(sunspots_ts)\n",
    "plot(diff_sunspots, main = \"Differenced Sunspots\", ylab = \"Differenced Sunspots Count\", xlab = \"Time\")\n\n",
    "# Check stationarity after differencing\n",
    "adf_test_diff <- adf.test(diff_sunspots, alternative = \"stationary\")\n",
    "cat(\"ADF Test After Differencing:\\n\")\n",
    "cat(\"P-value:\", adf_test_diff$p.value, \"\\n\")\n",
    "if (adf_test_diff$p.value < 0.05) {\n",
    "  cat(\"Conclusion: Differenced series is stationary.\\n\")\n",
    "} else {\n",
    "  cat(\"Conclusion: Differenced series is non-stationary.\\n\")\n",
    "}\n\n",
    "# Step 5: Model Selection\n",
    "# Using auto.arima for ARIMA model selection\n",
    "model <- auto.arima(sunspots_ts)\n",
    "cat(\"Selected ARIMA Model:\\n\")\n",
    "print(model)\n\n",
    ...
    "# Step 7: Forecasting\n",
    "forecast_result <- forecast(model, h = 120) # Forecasting for 10 years (120 months)\n",
    "plot(forecast_result, main = \"Forecast of Monthly Sunspots\", ylab = \"Sunspots Count\", xlab = \"Time\")\n\n",
    "# Step 8: Conclusions\n",
    "cat(\"Conclusions:\\n\")\n",
    "cat(\"1. The dataset initially was non-stationary as confirmed by stationarity tests.\\n\")\n",
    "cat(\"2. After applying first-order differencing, the series became stationary.\\n\")\n",
    "cat(\"3. The ARIMA model was selected automatically using AIC/BIC criteria.\\n\")\n",
    "cat(\"4. Model diagnostics confirmed that residuals behaved like white noise.\\n\")\n",
    "cat(\"5. Forecasting was successfully performed for 120 months.\\n\")\n\n",
    "#DATASET5\n",
    "# Load the dataset and required libraries\n",
    "data(\"USAccDeaths\")\n",
    "library(tseries)\n",
    ...
    "cat(\"Description: Monthly accidental deaths in the United States from 1973 to 1978.\\n\")\n",
    "summary(USAccDeaths)\n",
    "plot(USAccDeaths, main = \"US Accidental Deaths\", ylab = \"Number of Deaths\", xlab = \"Time\")\n\n",
    "# Step 2: Preprocessing\n",
    "# Check for missing values\n",
    "cat(\"Missing values:\", sum(is.na(USAccDeaths)), \"\\n\")\n",
    "cat(\"Time series start:\", start(USAccDeaths), \"\\n\")\n",
    "cat(\"Time series end:\", end(USAccDeaths), \"\\n\")\n",
    "cat(\"Frequency:\", frequency(USAccDeaths), \"\\n\")\n\n",
    "# Step 3: Stationarity Testing\n",
    "# ADF Test\n",
    "adf_test <- adf.test(USAccDeaths, alternative = \"stationary\")\n",
    "cat(\"ADF Test Results:\\n\")\n",
    "cat(\"P-value:\", adf_test$p.value, \"\\n\")\n",
    "if (adf_test$p.value < 0.05) {\n",
    ...
    "}\n\n",
    "# KPSS Test\n",
    "kpss_test <- kpss.test(USAccDeaths)\n",
    "cat(\"KPSS Test Results:\\n\")\n",
    "cat(\"P-value:\", kpss_test$p.value, \"\\n\")\n",
    "if (kpss_test$p.value < 0.05) {\n",
    "  cat(\"Conclusion: The series is non-stationary.\\n\")\n",
    ...
    "forecast_values <- forecast(fit, h = 24)\n",
    "plot(forecast_values, main = \"Forecast of US Accidental Deaths\",\n",
    "     ylab = \"Number of Deaths\", xlab = \"Time\")\n\n",
    "# Step 8: Conclusions\n",
    "cat(\"Summary of Findings:\\n\")\n",
    "cat(\"1. The US Accidental Deaths dataset shows clear seasonal patterns.\\n\")\n",
    "cat(\"2. Stationarity tests indicated the presence of non-stationarity.\\n\")\n",
    "cat(\"3. Seasonal decomposition revealed trend, seasonal, and random components.\\n\")\n",
    "cat(\"4. A SARIMA model was fitted to capture both trend and seasonality.\\n\")\n",
    "cat(\"5. Model diagnostics confirmed that residuals are approximately white noise.\\n\")\n",
    "cat(\"6. Seasonal variations and trends were observed, highlighting the importance of modeling for accurate predictions.\\n\")\n"
  )
)
