...
program_code <- list(
  ...
  program4 = paste0(
    ...
    "# Expand the dataset based on Freq column\n",
    ...
    "titanic_numeric <- data.frame(\n",
    "  Class = as.numeric(titanic_expanded$Class),\n",
    "  Sex = as.numeric(factor(titanic_expanded$Sex)),\n",
    "  Age = as.numeric(titanic_expanded$Age),\n",
    "  Survived = as.numeric(factor(titanic_expanded$Survived))\n",
    ")\n\n",
    ...
    "# Load and clean Adult Income dataset\n",
